...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {U: oldTime, ap: request, ar: subs};
	});
...
var author$project$Main$SleepDone = {$: 3};
...
var author$project$Main$shouldBallBounceVertically = function (ball) {
	var radius = ball.p;
	return (_Utils_cmp(ball.a, radius) < 1) || (_Utils_cmp(ball.a, 500 - radius) > -1);
};
		...
		if (!paddle.$) {
			...
			return author$project$Main$RightPaddle(
				_Utils_update(
					paddleInfo,
					{
						a: A3(elm$core$Basics$clamp, 0, 500 - paddleInfo.s, paddleInfo.a + amount)
					}));
		} else {
			var paddleInfo = paddle.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$core$String$fromInt(paddleInfo.S)),
